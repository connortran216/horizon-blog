# horizon-blog-y2e.5.1: Account and OAuth presentation

Project: Horizon Blog
Service: frontend
Dependencies: B5; upstream bundle
...
## Acceptance criteria
1. All account states match new system without token persistence, fabricated OAuth consent or changed session/authorization contracts.
