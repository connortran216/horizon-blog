# horizon-blog-y2e.6.2 implementation plan
...
- `src/features/series/pages/ManageSeriesPage.tsx`
- `src/features/author-analytics/pages/AnalyticsOverviewPage.tsx`
- `src/features/author-analytics/pages/BlogAnalyticsPage.tsx`
- `src/features/access-management/pages/AccessManagementPage.tsx`

## Technical approach
Reuse Chakra semantic tokens, existing feature components/hooks and service adapters. Owner states and role gates remain authoritative; loading/empty/error/denied states and responsive charts/tables use new system; no fixture data enters production.
