# horizon-blog-y2e.6.1: Editor and publishing

Project: Horizon Blog
Service: frontend
Dependencies: B6; upstream bundle
...
## Acceptance criteria
1. Writing/preview/upload/schedule controls match design; preserve autosave, permission loss, draft recovery, local dates and real publication contract.
