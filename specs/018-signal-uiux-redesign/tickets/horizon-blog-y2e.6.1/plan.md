# horizon-blog-y2e.6.1 implementation plan
...
- `src/features/editor/pages/BlogEditorPage.tsx`
- `src/features/editor/pages/PublishBlogPage.tsx`

## Technical approach
Reuse Chakra semantic tokens, existing feature components/hooks and service adapters. Writing/preview/upload/schedule controls match design; preserve autosave, permission loss, draft recovery, local dates and real publication contract.
