# horizon-blog-y2e.1.1: Design handoff and canonical documentation

Project: Horizon Blog
Service: frontend
Dependencies: B1; upstream bundle
...
## Acceptance criteria
1. Approved tokens, motion, coverage, references and QA limits are indexed with hashes; old guidance is explicitly superseded.
