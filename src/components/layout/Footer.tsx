    ...
    >
      ...
      >
        <Stack direction="row" spacing={6}>
          <Link href="/" color={linkColor} _hover={{ color: linkHoverColor }}>Home</Link>
          <Link href="/about" color={linkColor} _hover={{ color: linkHoverColor }}>About</Link>
          <Link href="/blog" color={linkColor} _hover={{ color: linkHoverColor }}>Blog</Link>
          <Link href="/contact" color={linkColor} _hover={{ color: linkHoverColor }}>Contact</Link>
        </Stack>
